...
import com.example.theuncleandgioppeproject.databinding.ActivityWriteDataBinding
...
class WriteData : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     binding = ActivityWriteDataBinding.inflate(layoutInflater)
        ...
        if (nfcAdapter == null) {
            val builder = AlertDialog.Builder(this@WriteData)
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        try {
            if(binding.txtmachineid.text.toString() != "" && !binding.txtshopid.text.toString().equals("") ) {
